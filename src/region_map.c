...
static const u16 sHoennRegionMapBg_Pal[] = INCBIN_U16("graphics/pokenav/region_map/hoenn/map.gbapal");
static const u32 sHoennRegionMapBg_GfxLZ[] = INCBIN_U32("graphics/pokenav/region_map/hoenn/map.8bpp.lz");
static const u32 sHoennRegionMapBg_TilemapLZ[] = INCBIN_U32("graphics/pokenav/region_map/hoenn/map.bin.lz");

#include "data/region_map/hoenn/region_map_layout.h"
#include "data/region_map/hoenn/region_map_entries.h"
...
bool8 LoadRegionMapGfx(void)
{
    ...
    case 2:
        if (!FreeTempTileDataBuffersIfPossible())
            LoadPalette(sHoennRegionMapBg_Pal, BG_PLTT_ID(7), 3 * PLTT_SIZE_4BPP);
        break;
    case 3:
