...
{
    if (gLocalTime.hours < NIGHT_HOUR_END)
        return TIME_NIGHT;
    else if (gLocalTime.hours < MORNING_HOUR_END)
        return TIME_MORNING;
    else if (gLocalTime.hours < DAY_HOUR_END)
        return TIME_DAY;
    else if (gLocalTime.hours < EVENING_HOUR_END)
        return TIME_EVENING;
